  ...
  return (
    <main>
      ...
      <section className="jobs-section">
        <div className="container">
          <div className="main_title">Current Jobs</div>
          <div className="row">
                ...
                <form>
                  <div className="input-group">
                    ...
                    <select className="form-control">
                      <option value="01">Job Opportunities</option>
                      <option value="01">Jobs Seekers</option>
                    </select>
                  </div>
                  ...
                  <div className="input-group">
                    ...
                    <select className="form-control">
                      ...
                      <option value="01">Accounting / Finance</option>
                      <option value="02">Automotive</option>
                      <option value="03">Beauty / Salon</option>
                    </select>
                  </div>
                  ...
                  <div className="input-group">
                    ...
                    <select className="form-control">
                      <option value="01">High-School / Secondary</option>
                      <option value="02">Bachelors Degree</option>
                      <option value="03">Masters Degree</option>
                      <option value="04">PhD</option>
                    </select>
                  </div>
                  ...
                  <div className="input-group">
                    ...
                    <select className="form-control">
                      <option value="01">Entry Level</option>
                      <option value="02">1-3 Years</option>
                      <option value="03">3-5 Years</option>
                      <option value="04">5+ Years</option>
                    </select>
                  </div>
                  ...
                  <div className="input-group">
                    ...
                    <select className="form-control">
                      <option value="01">$20k - $40k</option>
                      <option value="02">$40k - $60k</option>
                      <option value="03">$60k - $80k</option>
                      <option value="04">$80k+</option>
                    </select>
                  </div>
            ...
            <div className="col-lg-9 fadeInRight">
              <div className="job-listings">
                {/* Job Card 1 */}
                <div className="job-card">
                  <div className="row">
                    <div className="col-md-8">
                      <h4><a href="/job-single">Senior Software Developer</a></h4>
                      ...
                      <div className="job-meta">
                        ...
                        <span><i className="fas fa-dollar-sign"></i> $80k - $120k</span>
                      </div>
                    ...
                    <div className="col-md-4 text-right">
                      ...
                      <p className="posted-date">Posted 2 days ago</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="job-card">
                  <div className="row">
                    <div className="col-md-8">
                      <h4><a href="/job-single">Marketing Manager</a></h4>
                      <p className="company">Global Marketing Co.</p>
                      <div className="job-meta">
                        <span><i className="fas fa-map-marker-alt"></i> Los Angeles, CA</span>
                        <span><i className="fas fa-clock"></i> Full-time</span>
                        <span><i className="fas fa-dollar-sign"></i> $70k - $100k</span>
                      </div>
                      <p className="description">
                        Join our marketing team and help us grow our brand presence...
                      </p>
                    </div>
                    <div className="col-md-4 text-right">
                      <button className="btn btn-primary">Apply Now</button>
                      <p className="posted-date">Posted 1 week ago</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="job-card">
                  <div className="row">
                    <div className="col-md-8">
                      <h4><a href="/job-single">Data Analyst</a></h4>
                      <p className="company">Data Insights Ltd.</p>
                      <div className="job-meta">
                        <span><i className="fas fa-map-marker-alt"></i> Chicago, IL</span>
                        <span><i className="fas fa-clock"></i> Full-time</span>
                        <span><i className="fas fa-dollar-sign"></i> $60k - $90k</span>
                      </div>
                      <p className="description">
                    ...
                    <div className="col-md-4 text-right">
                      <button className="btn btn-primary">Apply Now</button>
                      <p className="posted-date">Posted 3 days ago</p>
                    </div>
                  </div>
                </div>
