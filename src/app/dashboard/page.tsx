export default function DashboardPage() {
  return (
    <main>
      ...
      {/* Dashboard Content */}
      <section className="pagecontent dashboard_wrap">
        <div className="container">
          <div className="row contactWrp">
            <div className="col-lg-3">
              <div className="card">
                ...
                <div className="card-body text-center item-user border-bottom">
                  <div className="profile-pic">
                    <div className="profile-pic-img">
                      <span className="bg-success dots" data-toggle="tooltip" data-placement="top" title="" data-original-title="online"></span>
                      <img src="/images/profile_img.jpg" className="brround" alt="user" />
                    </div>
                    <h4 className="mt-3 mb-0 font-weight-semibold">John</h4>
                  </div>
                </div>
                <div className="dash_widget-sec">
                  <ul>
                    <li><a href="/dashboard" title="" className="active"><i className="fas fa-th-large"></i> Dashboard</a></li>
                    <li><a href="/my-profile" title=""><i className="fas fa-user"></i>My Profile</a></li>
                    <li><a href="/create-cv" title=""><i className="fas fa-file-alt"></i>Create CV</a></li>
                    <li><a href="/job-form" title=""><i className="fas fa-file-alt"></i>Employer</a></li>
                    <li><a href="/change-password" title=""><i className="fas fa-lock"></i>Change Password</a></li>
                    <li><a href="#" title=""><i className="fas fa-sign-out-alt"></i>Logout</a></li>
                  </ul>
                </div>
              </div>
            </div>
                      ...
                      <div className="col-lg-3 col-md-6 col-sm-6">
                        <div className="item-all-card text-dark text-center card">
                          ...
                          <div className="item-all-text mt-3">
                            <h5 className="mb-0 text-body">Profile</h5>
                          </div>
                        </div>
                      </div>
                      <div className="col-lg-3 col-md-6 col-sm-6">
                        <div className="item-all-card text-dark text-center card">
                          ...
                          <div className="item-all-text mt-3">
                            <h5 className="mb-0 text-body">Employer</h5>
                          </div>
                        </div>
                      </div>
                      <div className="col-lg-3 col-md-6 col-sm-6">
                        <div className="item-all-card text-dark text-center card">
                          ...
                          <div className="item-all-text mt-3">
                            <h5 className="mb-0 text-body">Import Cv</h5>
                          </div>
                        </div>
                      </div>
                      <div className="col-lg-3 col-md-6 col-sm-6">
                        <div className="item-all-card text-dark text-center card">
                          ...
                          <div className="item-all-text mt-3">
                            <h5 className="mb-0 text-body">Jobs</h5>
                          </div>
                        </div>
                      </div>
                    </div>
